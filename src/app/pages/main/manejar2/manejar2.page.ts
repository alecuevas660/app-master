...
export class Manejar2Page implements OnInit {
  ...
  constructor(private crud: CrudService, public ToastController:ToastController, public firebase1:FirestoreService, public database: FirestoreService,
...
this.fono ="";
 ...
 async save(){
    ...
    data.id = this.firebase1.creatId();
    const enlace = 'Viajes';
